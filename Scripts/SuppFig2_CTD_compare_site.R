...
### Supplemental Figure 2: Timeseries of salinity and temperature from SGD experimental locations
...
#############################
#### SUPPLEMENTAL FIGURE 2: SGD ENVIRONMENTAL DATA ####
#############################
...
#ggsave(here("Output", "PaperFigures","SuppFig2.png"),salPlot, device = "png", width = 8, height = 6)
