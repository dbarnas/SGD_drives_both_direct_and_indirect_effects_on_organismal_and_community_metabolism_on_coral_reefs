#### Figure 1 and Supplemental Figure 3: Environmental characteristics of SGD experimental locations
...
# ggsave(here("Output","PaperFigures","SuppFig3.png"), supp.plot2.full, device = "png", width = 8, height = 5)
